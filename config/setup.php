...
'SecretCode' => '73QNcOn;EBj;oav8,S~+sV0SgEf(XRpX',
...
// ... предыдущие настройки (SMTP и т.д.)
    'SMTPAuth' => true,

    // Добавляем нашу заплатку для Open Server 6 прямо сюда:
    'IncludeAdminPath' => dirname(__DIR__) . '/adminpanel/',
];
